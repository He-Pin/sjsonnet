...
abstract class Materializer {
  ...
  def stringify(v: Val)(implicit evaluator: EvalScope): String = {
    // Fast path for leaf types: avoid Renderer allocation
    v match {
